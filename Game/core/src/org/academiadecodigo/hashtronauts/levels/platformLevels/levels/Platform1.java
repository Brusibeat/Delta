...
public class Platform1 extends PlatformLevel {
    ...
    public void initLevelObjects(){
        ...
        gameObjects.add(GameObjectFactory.createPlatform(null, 550, 350+ Configurations.GROUND_LEVEL, 100, 20));
        gameObjects.add(GameObjectFactory.createPlatform(null, 750, 350+ Configurations.GROUND_LEVEL, 100, 20));
